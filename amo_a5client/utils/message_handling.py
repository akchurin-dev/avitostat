...
from amo.utils import message_handling as default_pipeline_message_handling
...
def prepare_message_handling_data(task_id: int, avito_account_id: int, *, trace_id: str) -> None:
    ...
    def f(avito_account_id: int, *, task_id: int, trace_id: str) -> None:
        ...
        chat = messaging.api.get_chat_last_50_messages_by_chat_id(avito_account, task.chat_id, tlogger=tlogger)
