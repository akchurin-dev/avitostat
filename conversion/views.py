...
def get_conversions(statistics, operations: list) -> dict:
    conversions = {}
...
class Test(View):
    def get(self, request, *args, **kwargs):
        ...
        conversions = get_conversions(statistics=statistics, operations=operations)
        if conversions:
            return JsonResponse(status=200, data=conversions)
